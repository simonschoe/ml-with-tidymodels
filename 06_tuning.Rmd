...
**Shortcut:** Step 8 and 9 can be abbreviated by using `last_fit()`. It fits the finalized workflow on the training set, predicts the unseen cases in the test set and evaluates the model's test set performance.
