...
*Note: After the removal of missing values in the `sex`, `citizenship`, `peak_name` and `expedition_role` predictor the data set shrinks from `r dim(tt_data$members)[1] %>% scales::comma(big.mark = ",")` to `r dim(climbers_df)[1] %>% scales::comma(big.mark = ",")` observations.*
]]]
